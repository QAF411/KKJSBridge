...
(function (global, factory) {
  ...
  var KKJSBridge = /** @class */ (function () {
     ...
     * @param callback 调用回调
     */
    KKJSBridge.prototype.callNative = function (
      module,
      method,
      data,
      callback
    ...
    KKJSBridge.prototype.syncCall = function (module, method, data) {
      ...
      try {
        ...
        console.log(
          "window.prompt will happen error when beforeunload event triggered",
          e
        );
        return null;
      }
  ...
  var _KKJSBridgeCOOKIE = /** @class */ (function () {
    ...
    _KKJSBridgeCOOKIE.setupHook = function () {
      try {
        ...
        if (cookieDesc && cookieDesc.configurable) {
          Object.defineProperty(document, "cookie", {
            ...
            get: function () {
              ...
              if (
                window.KKJSBridgeConfig.ajaxHook &&
                window.KKJSBridgeConfig.cookieGetHook
              ) {
                var cookieJson = window.KKJSBridge.syncCall(
                  _KKJSBridgeCOOKIE.moduleName,
                  "cookie",
                  {
            ...
            set: function (val) {
              ...
              if (window.KKJSBridgeConfig.cookieSetHook) {
                // 如果开启 cookie set hook，则需要把 cookie 同步给 Native
                window.KKJSBridge.call(
                  _KKJSBridgeCOOKIE.moduleName,
                  "setCookie",
                  {
                    cookie: val,
        ...
        console.log(
          "this browser does not support reconfigure document.cookie property",
          e
        );
      }
    };
